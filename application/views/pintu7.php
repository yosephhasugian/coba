...
<body>
  ...
  <!-- Spinner End -->
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr class="table-primary">
                <th scope="row">KALINGGA JAYA</th>
                <td>KARINA</td>
                <td>LORENA</td>
                <td>MAWAR</td>
                <td>MUJI JAYA PUTRA MANDIRI</td>
              </tr>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card">
          <table class="table">
            ...
            <tbody>
              <tr>
                <th scope="row">TASIKMALAYA</th>
                <td>BANJAR</td>
                <td>SURABAYA</td>
              </tr>
          
              <tr class="table-primary">
                <th scope="row">MALANG</th>
                <td>BANGKALAN</td>
                <td>SAMPANG</td>
              </tr>
              <tr class="table-secondary">
                <th scope="row">PEMEKASAN</th>
                <td>SUMENEP</td>
                <td>MATARAM</td>
              </tr>
              <tr class="table-success">
              ...
              <tr class="table-info">
                <th scope="row">KUDUS</th>
                <td>PATI</td>
                <td>REMBANG</td>
              </tr>
              <tr class="table-light">
                <th scope="row">BLORA</th>
                <td>PATI</td>
                <td>CEPU</td>
              </tr>
          ...
          <br>
        <div class="card">
        <button class="btn btn-primary btn-lg active" role="button" onclick="openFullscreen();">WAJIB MENGGUNAKAN MASKER</button>
      </div>
          <br>
          <div class="card">
            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 1000;">
        <div class="px-2 bg-light "><h1><b><center>LAJUR 23 - LAJUR 24 - LAJUR 25 - LAJUR 26 - LAJUR 27 - LAJUR 28 </b></h1></div>
      </nav>
    </div>
    </div>
  </section>
